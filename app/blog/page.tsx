...
import { Folder, FileText, BookOpen, Sparkles } from "lucide-react";
...
export default function BlogPage() {
  ...
  const filteredBlogs = useMemo(() => {
    ...
    if (selectedCollection === "all") {
      ...
      result = blogs.filter(b => !b.collection);
    } else {
  ...
  const searchedBlogs = filteredBlogs.filter(
    (b) =>
              ...
              <div className="flex flex-col sm:flex-row gap-4 items-center justify-between">
                <div className="flex items-center gap-3 w-full sm:w-auto">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-muted-foreground">共 {searchedBlogs.length} 篇文章</p>
                  </div>
                </div>
                <div className="flex items-center gap-3 w-full sm:w-auto">
