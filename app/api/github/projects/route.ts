...
export async function GET() {
  ...
  try {
    ...
    // The files are stored in data/projects/ directory
...
async function fetchProjectContent(file: any, collection?: string) {
  try {
    const GITHUB_TOKEN = process.env.GITHUB_TOKEN;
    ...
    return {
      ...
      createdAt: frontmatter.createdAt || new Date(file.created_at).toISOString(),
